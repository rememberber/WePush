...
public enum MessageTypeEnum {
    ...
    public static final int NETEASE_YUN_XIN_CODE = 6;
    ...
    public static final int FEISHU_CODE = 25;
    public static final int CARRIER_SMS_CODE = 26;
