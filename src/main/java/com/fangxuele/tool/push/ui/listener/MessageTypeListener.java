...
public class MessageTypeListener {
    ...
    public static void addListeners() {
        ...
        messageTypeForm.get网易云信短信RadioButton().addActionListener(e -> {
        ...
        messageTypeForm.get极光短信RadioButton().addActionListener(e -> {
        ...
        messageTypeForm.getFeishuRadioButton().addActionListener(e -> {
