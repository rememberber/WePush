 ...
 */
@Getter
public class HwYunMsgForm implements IMsgForm {
    ...
    public void init(Integer msgId) {
        ...
        initTemplateDataTable();
        // 模板消息Data表
        List<TTemplateData> templateDataList = templateDataMapper.selectByMsgTypeAndMsgId(MessageTypeEnum.HW_YUN_CODE, msgId);
    ...
    public void save(Integer accountId, String msgName) {
        ...
        List<TMsgSms> tMsgSmsList = msgSmsMapper.selectByUnique(accountId, MessageTypeEnum.HW_YUN_CODE, msgName);
    ...
    public static HwYunMsgForm getInstance() {
        if (hwYunMsgForm == null) {
            hwYunMsgForm = new HwYunMsgForm();
        }
        return hwYunMsgForm;
    }
