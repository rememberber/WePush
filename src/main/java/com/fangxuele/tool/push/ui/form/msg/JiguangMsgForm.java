 ...
 */
@Getter
public class JiguangMsgForm implements IMsgForm {
    ...
    private static JiguangMsgForm jiguangMsgForm;

    private static TMsgMapper msgMapper = MybatisUtil.getSqlSession().getMapper(TMsgMapper.class);

    public JiguangMsgForm() {
    ...
    public void save(Integer accountId, String msgName) {
        ...
        TMsg tMsg = msgMapper.selectByUnique(MessageTypeEnum.JIGUANG_CODE, accountId, msgName);
        if (tMsg != null) {
            existSameMsg = true;
            msgId = tMsg.getId();
        }
        ...
        if (!existSameMsg || isCover == JOptionPane.YES_OPTION) {
            ...
            msg.setMsgType(MessageTypeEnum.JIGUANG_CODE);
    ...
    public static JiguangMsgForm getInstance() {
        if (jiguangMsgForm == null) {
            jiguangMsgForm = new JiguangMsgForm();
        }
        return jiguangMsgForm;
    }
