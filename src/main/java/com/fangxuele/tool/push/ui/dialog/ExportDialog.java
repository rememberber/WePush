...
public class ExportDialog extends JDialog {
    ...
    public ExportDialog() {
        ...
        excelRadioButton.addActionListener(e -> {
            unSelectAll();
    ...
    public static void showDialog() {
        ...
        exportDialog.unSelectAll();
        exportDialog.excelRadioButton.setSelected(true);
        fileType = EXCEL;
        exportDialog.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.setLayout(new GridLayoutManager(3, 1, new Insets(0, 10, 0, 10), -1, -1));
        ...
        excelRadioButton = new JRadioButton();
        excelRadioButton.setText("Excel");
        panel3.add(excelRadioButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        csvRadioButton = new JRadioButton();
        csvRadioButton.setText("CSV");
        panel3.add(csvRadioButton, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        txtRadioButton = new JRadioButton();
        txtRadioButton.setText("TXT");
        panel3.add(txtRadioButton, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
