 ...
 */
@Getter
public class NeteaseYunXinMsgForm implements IMsgForm {
    ...
    private static NeteaseYunXinMsgForm neteaseYunXinMsgForm;

    private static TMsgMapper msgMapper = MybatisUtil.getSqlSession().getMapper(TMsgMapper.class);

    public NeteaseYunXinMsgForm() {
    ...
    public void save(Integer accountId, String msgName) {
        ...
        TMsg tMsg = msgMapper.selectByUnique(MessageTypeEnum.NETEASE_YUN_XIN_CODE, accountId, msgName);
        if (tMsg != null) {
            existSameMsg = true;
            msgId = tMsg.getId();
        }
        ...
        if (!existSameMsg || isCover == JOptionPane.YES_OPTION) {
            ...
            msg.setMsgType(MessageTypeEnum.NETEASE_YUN_XIN_CODE);
    ...
    public static NeteaseYunXinMsgForm getInstance() {
        if (neteaseYunXinMsgForm == null) {
            neteaseYunXinMsgForm = new NeteaseYunXinMsgForm();
        }
        return neteaseYunXinMsgForm;
    }
