 ...
 */
@Getter
public class ZhenziYunMsgForm implements IMsgForm {
    ...
    private static ZhenziYunMsgForm zhenziYunMsgForm;

    private static TMsgMapper msgMapper = MybatisUtil.getSqlSession().getMapper(TMsgMapper.class);

    public ZhenziYunMsgForm() {
    ...
    public void save(Integer accountId, String msgName) {
        ...
        TMsg tMsg = msgMapper.selectByUnique(MessageTypeEnum.ZHENZI_YUN_CODE, accountId, msgName);
        if (tMsg != null) {
            existSameMsg = true;
            msgId = tMsg.getId();
        }
        ...
        if (!existSameMsg || isCover == JOptionPane.YES_OPTION) {
            ...
            msg.setMsgType(MessageTypeEnum.ZHENZI_YUN_CODE);
    ...
    public static ZhenziYunMsgForm getInstance() {
        if (zhenziYunMsgForm == null) {
            zhenziYunMsgForm = new ZhenziYunMsgForm();
        }
        return zhenziYunMsgForm;
    }
