 ...
 */
@Getter
public class QiNiuYunMsgForm implements IMsgForm {
    ...
    public void init(Integer msgId) {
        ...
        initTemplateDataTable();
        // 模板消息Data表
        List<TTemplateData> templateDataList = templateDataMapper.selectByMsgTypeAndMsgId(MessageTypeEnum.QI_NIU_YUN_CODE, msgId);
    ...
    public void save(Integer accountId, String msgName) {
        ...
        List<TMsgSms> tMsgSmsList = msgSmsMapper.selectByUnique(accountId, MessageTypeEnum.QI_NIU_YUN_CODE, msgName);
    ...
    public static QiNiuYunMsgForm getInstance() {
        if (qiNiuYunMsgForm == null) {
            qiNiuYunMsgForm = new QiNiuYunMsgForm();
        }
        return qiNiuYunMsgForm;
    }
