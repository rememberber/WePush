package com.fangxuele.wepush.next.plugin.smpp;
...
@Extension
public final class SmppProviderExtension implements ProviderFactoryExtension {
    @Override public ProviderFactory factory() { return new CarrierSmsProviderFactory(CarrierProtocol.SMPP); }
}
