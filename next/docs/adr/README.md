...
产品定位、长期非目标和迭代优先级以[《产品目标、边界与路线图》](../product-scope-and-roadmap.md)为准；ADR 不得以技术扩展名义改变该产品边界。
...
| [ADR-0007](0007-artifact-store-and-retention.md) | 已接受 | Standalone 本地制品、用户自建 Server S3-compatible 制品及保留策略 |
| [ADR-0008](0008-workspace-multitenancy-scope.md) | 已接受 | Workspace 只作为同一自建实例信任域内的逻辑隔离 |
